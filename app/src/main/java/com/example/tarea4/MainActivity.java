...
import com.example.tarea4.datos.conexion;
import com.example.tarea4.datos.consulta;
import java.io.File;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void dispatchTakePictureIntent(){
        ...
        if(takePictureIntent.resolveActivity(getPackageManager())!=null){
            ...
            if(photoFile!=null){
                Uri photoURI= FileProvider.getUriForFile(this,"com.example.tarea4.fileprovider",photoFile);
